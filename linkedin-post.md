...
This pipeline exists because of @Panos.
...
This idea was entirely @Panos's — he saw the gap between "LSP for validation" and "LSP as a development tether" and pushed me to build it. The pipeline is the result of that conversation.
